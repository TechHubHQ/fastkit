...
def version():
    ...
    console.print(Columns([system_table, features_table], equal=True, expand=True))
    console.print()
    ...
    footer_text.append("https://github.com/your-repo/fastkit", style="bright_blue underline")
    ...
    console.print(Rule("[bright_cyan]Thank you for using FastKit! 🚀[/bright_cyan]", style="bright_cyan"))
    console.print()
